...
### 예를 들어
* 금고 털기: 발상의 전환만 할 수 있다면, 주먹구구식으로 돌려도 풀 수 있다. -> 1.5레벨
* 물웅덩이 (Easy): 그래프의 기본 이론만 알고 있어도 무지성으로 풀이 가능 -> 2레벨
* 바람개비: 구현은 간단하나, 수식 유도가 상당히 어렵다. -> 3.5레벨
* 물웅덩이 (Hard): 중상급 알고리즘과 집합론을 사전 지식으로 요구하고 있는 데다 구현 마저도 상당히 어렵고 모듈러 연산에 주의해야 한다. ->  4.5레벨
